...
var Pic = function Pic(id) {
	this._config = {}, this._id = typeof id == 'string' ? document.querySelector(id) : id;
...
Pic.prototype = {
	constructor: Pic,
	picAnimate: function picAnimate() {
	...
	_selfPosition: function _selfPosition(pos) {
		var that = this;
		var _pos = function _pos() {
	...
	_picAnimate: function _picAnimate(fn) {
		return this.picAnimate()(fn);
	},
	picInit: function picInit() {
		var that = this;
